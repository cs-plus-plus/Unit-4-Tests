...
public class Unit4 {
 ...
 // Method 1: Sum numbers from 1 to n
 public int sumNumbers(int n) {
     // TODO: Implement the method
     return 0;
 }

 // Method 2: Repeat a given string n times
 public String repeatString(String str, int n) {
     // TODO: Implement the method
     return "";
 }

 // Method 3: Find the factorial of a given number
 public int findFactorial(int n) {
     // TODO: Implement the method
     return 0;
 }

 // Method 4: Count the number of vowels in a given string
 public int countVowels(String str) {
     // TODO: Implement the method
     return 0;
 }

 // Method 5: Check if a string is a palindrome
